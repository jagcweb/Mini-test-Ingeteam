                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('task.update', ['id' => $task->id]) }}">
                        ...
                        <div class="form-group row">
                            ...
                            @if(\Auth::user()->rol == 'admin')
                                <select class="form-control" name="user">
                                    <option value="" selected disabled hidden>{{$task->user->email}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" class="form-control" name="description" placeholder="{{$task->description}}"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <option value="{{$task->title}}" selected disabled hidden>{{$task->priority}}</option>
